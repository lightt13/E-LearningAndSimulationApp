...
public class Module3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageButton btn1 = findViewById(R.id.m1Btn18);
        ImageButton btn2 = findViewById(R.id.m1Btn19);
        ImageButton btn3 = findViewById(R.id.m1Btn20);
        TextView modules = findViewById(R.id.m1Modules2);
        String username = getIntent().getExtras().getString("username");
        TextView header = findViewById(R.id.moduleOneHeader3);
