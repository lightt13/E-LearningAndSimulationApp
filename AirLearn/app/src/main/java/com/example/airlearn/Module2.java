...
public class Module2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageButton btn1 = findViewById(R.id.m1Btn15);
        ImageButton btn2 = findViewById(R.id.m1Btn16);
        ImageButton btn3 = findViewById(R.id.m1Btn17);
        TextView modules = findViewById(R.id.m1Modules);
        String username = getIntent().getExtras().getString("username");
        TextView header = findViewById(R.id.moduleOneHeader2);
